    ...
    <body>
                ...
                <g:each in="${campanaInstanceList}" status="i" var="campanaInstance">
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-small btn-edit btn-ajax" href="#" rel="tooltip" title="Editar" data-id="${campanaInstance.id}">
                                <i class="icon-pencil icon-large"></i>
                            </a>

                            <a class="btn btn-small btn-delete" href="#" rel="tooltip" title="Eliminar" data-id="${campanaInstance.id}">
        ...
        <script type="text/javascript">
            ...
            function submitForm(btn) {
                if ($("#frmSave-Campana").valid()) {
                    btn.replaceWith(spinner);
                }
                $("#frmSave-Campana").submit();
            }
