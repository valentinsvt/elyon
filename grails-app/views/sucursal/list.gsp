...
<html>
    ...
    <body>
        ...
        %{--<div id="list-Sucursal" class="span12" role="main" style="margin-top: 10px;">--}%
        ...
        <div class="modal hide fade" id="modal-Sucursal">
        ...
        <script type="text/javascript">
            ...
            function submitForm(btn) {
                if ($("#frmSave-Sucursal").valid()) {
                    btn.replaceWith(spinner);
                }
                $("#frmSave-Sucursal").submit();
            }
            ...
            $(function () {
                ...
                $(".btn-new").click(function () {
                    $.ajax({
                        ...
                        success : function (msg) {
                            ...
                            $("#modalTitle").html("Crear Sucursal");
                            $("#modalBody").html(msg);
                ...
                $(".btn-delete").click(function () {
                    ...
                    btnDelete.click(function () {
                        ...
                        $("#frmDelete-Sucursal").submit();
                        return false;
                    });

                    $("#modalHeader").removeClass("btn-edit btn-show btn-delete").addClass("btn-delete");
                    $("#modalTitle").html("Eliminar Sucursal");
                    $("#modalBody").html("<p>¿Está seguro de querer eliminar este Sucursal?</p>");
