...
<g:form action="saveGestion" name="frmGestion">
    ...
    <fieldset class="borde">
        ...
        <div class="span2 btn-group" style="margin-top: 20px; margin-bottom: 20px; margin-left: 450px">
            ...
            <g:link controller="reproceso" action="busqueda" class="btn btn-salir"><i class="icon-hand-left"></i>Salir</g:link>
            <g:link controller="reproceso" action="saveGestion" class="btn btn-guardar btn-primary"><i class="icon-save"></i>Guardar</g:link>
